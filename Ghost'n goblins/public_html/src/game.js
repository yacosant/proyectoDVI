...
Q.scene("L1",function(stage) {
  ...
  var levelAssets = [
      ...
      ["ArmorGhost",{x:(164*32)+16,y:(18*32)+16}],
      ["ArmorGhost",{x:(168*32)+16,y:(18*32)+16}],
      ["Plant",{x:(169*32)+16,y:(21*32)+16}],
      ["ArmorGhost",{x:(186*32)+16,y:(18*32)+16}],
      ["ArmorGhost",{x:(190*32)+16,y:(18*32)+16}],
      ["Plant",{x:(192*32)+16,y:(21*32)+16}],
      ["ArmorGhost",{x:(210*32)+16,y:(18*32)+16}],
      ["ArmorGhost",{x:(214*32)+16,y:(18*32)+16}],
      //Bosque linde
